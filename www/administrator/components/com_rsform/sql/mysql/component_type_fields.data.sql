...
(411, 'REQUIRED', 'select', 'NO\r\nYES', '{"case":{"YES":{"show":["VALIDATIONCALENDAR", "VALIDATIONMESSAGE"],"hide":[]},"NO":{"show":[],"hide":["VALIDATIONCALENDAR", "VALIDATIONMESSAGE"]}}}', 5),
...
(411, 'TIMEPICKER', 'select', 'YES\r\nNO', '{"case":{"YES":{"show":["TIMESTEP" ,"MINTIMEJQ", "MAXTIMEJQ"],"hide":[]},"NO":{"show":[],"hide":["TIMESTEP" ,"MINTIMEJQ", "MAXTIMEJQ"]}}}', 11),
(411, 'TIMESTEP', 'textbox', '30', '', 12),
(411, 'MINTIMEJQ', 'textarea', '', '', 13),
(411, 'MAXTIMEJQ', 'textarea', '', '', 14),
(411, 'ADDITIONALATTRIBUTES', 'textarea', '', '', 15),
(411, 'CALENDARLAYOUT', 'select', 'FLAT\r\nPOPUP', '{"case":{"POPUP":{"show":["READONLY", "POPUPLABEL"],"hide":[]},"FLAT":{"show":[],"hide":["READONLY", "POPUPLABEL"]}}}', 16),
(411, 'READONLY', 'select', 'NO\r\nYES', '', 17),
(411, 'POPUPLABEL', 'textbox', '...', '', 18),
