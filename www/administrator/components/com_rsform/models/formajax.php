		...
		foreach ($results as $result)
		{
			...
			switch ($result->FieldType)
			{
				...
				case 'textarea':
				{
					...
					$field->body .= '<textarea id="'.$field->name.'" name="param['.$field->name.']" tabindex="'.$taborder.'" rows="5" cols="20" class="rsform_txtarea" '. $additional .'>'.RSFormProHelper::htmlEscape($value).'</textarea></td>';
				}
					break;
