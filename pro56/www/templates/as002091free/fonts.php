...
function fontChooser($fontfamily)
{
	...
	switch($fontfamily)
	{
		...
		case 'Numans':
			...
			break;	
		case 'Open Sans':
			$font_arr['fontlink'] = "<link href='https://fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic&subset=latin,greek,cyrillic' rel='stylesheet' type='text/css'>";
