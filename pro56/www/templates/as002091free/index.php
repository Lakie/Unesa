...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/ext.superfish.css" type="text/css" /> 
    <link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/ext.ascarousel.css" type="text/css" />   
...
<body class="<?php echo $option . " view-" . $view . " task-" . $task . " itemid-" . $itemid . " body-" . $pageClass;?>">
    ...
    $doc->addScript($this->baseurl.'/templates/'.$this->template.'/js/formplugin.js');
    $doc->addScript($this->baseurl.'/templates/'.$this->template.'/js/init.js');
    $doc->addScript($this->baseurl.'/templates/'.$this->template.'/js/myScript.js');
    ?>
    <script src="https://www.gismeteo.ua/ajax/getInformer/?hash=n75sc176m4kjQA" type="text/javascript"></script>
